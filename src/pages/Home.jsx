      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-lg shadow-lg p-6 mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            through interactive visualizations. You can explore both
            one-dimensional and two-dimensional implementations of SOM.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-lg shadow-lg p-6 transform transition-all duration-300 hover:scale-105 h-full grid grid-rows-[auto,1fr,auto]">
            ...
            <div className="mt-4">
              <Link
                to="/one-dimension"
                className="inline-block w-full text-center bg-gradient-to-r from-blue-500 to-indigo-500 dark:from-blue-600 dark:to-indigo-600 text-white font-medium py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition-all"
              >
